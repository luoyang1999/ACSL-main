...
log_level = 'INFO'
work_dir = './work_dirs/head3/faster_rcnn_r50_fpn_1x_lr2e2_lvis_3expert_trainhead_stage2'
...
load_from = './work_dirs/fixlohead2ss_reg/faster_rcnn_r50_fpn_1x_lr2e2_lvis_3expert_trainhead/latest.pth'
resume_from = None
