...
log_level = 'INFO'
work_dir = './work_dirs/acsl/faster_rcnn_r50_fpn_1x_lvis_tunefc_acsl'
# load_from = './data/download_models/R50-baseline.pth'
# load_from = './data/pretrained_models/faster_rcnn_r50_fpn_lvis_1x_baseline_map21.pth'
# load_from = './data/pretrained_models/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15.pth'
load_from = './work_dirs/baselines/faster_rcnn_r50_fpn_1x_lvis/latest.pth'
resume_from = None
workflow = [('train', 1)]
