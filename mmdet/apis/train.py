...
# WT 2020-10-15
from .lamb import make_lamb_optimizer
...
def build_optimizer(model, optimizer_cfg):
    ...
    # WT 2020-10-15
    type_options = optimizer_cfg.get('type')
    if type_options == 'lamb':
        return make_lamb_optimizer(optimizer_cfg, model)
    ...
    if paramwise_options is None:
        ...
        # get frozen layers options
        frozen_layers = paramwise_options.get('frozen_layers', [])
